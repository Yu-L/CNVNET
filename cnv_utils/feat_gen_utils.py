...
Created by Yu Liu on 2019/8/14 2:15 PM.
"""
import os
import numpy as np
import pandas as pd
...
import logging
import sys
packages_dir = os.path.split(os.path.realpath(__file__))[0]
...
def load_gap(gap_fn=os.path.join(packages_dir,'../hg38_config/gap.txt')):
    """
